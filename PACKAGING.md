...
│   ├── simulation_compressor-0.1.0-py3-none-any.whl
...
pip install dist/simulation_compressor-0.1.0-py3-none-any.whl
...
```bash
pip install /path/to/simulation_compressor-0.1.0-py3-none-any.whl
```
