...
│   ├── aerocfd-1.1.2-py3-none-any.whl
│   └── aerocfd-1.1.2.tar.gz
...
pip install "dist/aerocfd-1.1.2-py3-none-any.whl[full]"
...
```bash
pip install /path/to/aerocfd-1.1.2-py3-none-any.whl
```
